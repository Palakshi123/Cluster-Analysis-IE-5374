...
#Task
In this task we’re presented with a data-set that looks at various socioeconomic parameters for nearly 200 countries. We have divided our analysis on the basis of three major criterion:
