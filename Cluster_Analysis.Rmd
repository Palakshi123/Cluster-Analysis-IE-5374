...
#Cluster Analysis using K-means clustering method
...
#Cluster Analysis using the K-means clustering method
...
#Cluster Analysis using the hirercial clustering method
...
#Create a 2D plot for both kmeans model and hirercial model
p3 = fviz_cluster(km1, db1[,c(1,2)], geom = "point", stand = FALSE) 
p4 = fviz_cluster(list(data= db1[,c(1,2)], cluster = db1$class2), geom = "point", stand = FALSE) 
p5 = fviz_cluster(km2, db2[,c(1,2)], geom = "point", stand = FALSE) 
p6= fviz_cluster(list(data= db2[,c(1,2)], cluster = db2$class2), geom = "point", stand = FALSE) 
...
#Cluster analysis using the hirercial method
hc = hclust(dist(df1[,1:2]),method = "single")
plot(hc)
...
#Cluster analysis using the hirerical method
